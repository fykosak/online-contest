...
namespace FOL\Modules\FrontendModule\Components\TeamForm;
...
class TeamFormComponent extends BaseComponent {
    ...
    public function insertSubmitted(Form $form): void {
        ...
        try {
            ...
            $template->setFile(APP_DIR . '/FrontendModule/templates/mail/registration.' . $this->getPresenter()->lang . '.latte');
