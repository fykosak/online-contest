...
(
    ...
    `lang`            enum ('cs','en','sk','hu','pl','ru') COLLATE utf8_czech_ci NOT NULL COMMENT 'jazyk notifikace',
...
INSERT INTO `notification` (`notification_id`, `message`, `lang`, `created`)
VALUES (1, 'Soutěž začala.', 'cs', '2019-11-27 17:00:00'),
