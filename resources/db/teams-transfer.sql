...
-- TRUNCATE TABLE `team`;
INSERT into team(id_team, id_year, name, password, category, email, address)
SELECT id_team, id_year, name, password, category, email, address from `view_team`;
...
INSERT into competitor(id_competitor, id_team, id_school, name, email, study_year)
SELECT vc.id_competitor, t.id_team, s.id_school, vc.name, vc.email, vc.study_year from `view_competitor` vc
